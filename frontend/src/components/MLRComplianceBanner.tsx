...
export default function MLRComplianceBanner() {
  return (
    <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-6 py-2 flex flex-wrap items-center justify-between text-xs text-slate-500 dark:text-slate-500 dark:text-slate-400">
      ...
      <div className="flex items-center space-x-2 text-slate-500 dark:text-slate-500">
