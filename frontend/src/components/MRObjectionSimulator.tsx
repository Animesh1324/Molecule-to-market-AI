      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
          ...
          <div className="mt-2 text-xs text-slate-400">
            <span className="font-semibold text-slate-300">Underlying Concern: </span>
            {current.underlying_concern}
          </div>
        </div>

        {/* Recommended MR Response */}
        <div className="p-5 rounded-xl bg-emerald-950/30 border border-emerald-800/60">
        ...
        {/* Supporting evidence */}
        <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
          <div className="flex items-center space-x-2">
            <BookOpen className="w-4 h-4 text-teal-400" />
            <span className="text-slate-400">Supporting Landmark Clinical Trial:</span>
            <span className="font-semibold text-teal-300">{current.supporting_clinical_trial}</span>
          </div>
          <div className="text-slate-400">
            <span>Refer to Visual Aid: </span>
            <span className="font-bold text-brand-400">Slide {current.recommended_visual_aid_page}</span>
          </div>
        </div>
      </div>
    </div>
