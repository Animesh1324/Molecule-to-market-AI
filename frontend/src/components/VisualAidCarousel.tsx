  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          <div className="flex items-center space-x-2 text-xs font-mono text-teal-400 uppercase tracking-wider">
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-xl overflow-hidden shadow-inner">
        {/* Top Slide Header */}
        <div className="bg-gradient-to-r from-slate-900 via-brand-950/60 to-slate-900 p-5 border-b border-slate-800">
          <div className="text-xs font-mono text-brand-400 tracking-wider uppercase">{brandName} Clinical Detailing</div>
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-12 gap-6">
          {/* Visual Concept Box */}
          <div className="md:col-span-5 bg-slate-900/90 rounded-xl p-5 border border-slate-800 flex flex-col justify-between space-y-4">
            <div>
              <div className="text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">
                Visual & Infographic Concept
              </div>
              <p className="text-sm text-slate-300 italic bg-slate-950/80 p-3 rounded-lg border border-slate-800/80">
          ...
          <div className="md:col-span-7 flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              ...
              {current.key_bullet_points.map((pt, pIdx) => (
                <div key={pIdx} className="flex items-start space-x-3 p-3 rounded-lg bg-slate-900/60 border border-slate-800/80">
            ...
            <div className="p-4 rounded-xl bg-slate-900/95 border-l-4 border-brand-500 shadow-md">
        ...
        <div className="bg-slate-900/90 px-6 py-3 border-t border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
          <div className="text-slate-400">
            <span className="font-semibold text-slate-300">Reference: </span>
            <span className="font-mono text-teal-400">{current.evidence_citation}</span>
          </div>
      ...
      <div className="flex items-center justify-between mt-4 pt-2">
        <button
          ...
          className="flex items-center space-x-1.5 px-4 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-medium transition disabled:opacity-30 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          className="flex items-center space-x-1.5 px-4 py-2 rounded-lg bg-brand-600 hover:bg-brand-500 text-white text-sm font-medium transition disabled:opacity-30 disabled:cursor-not-allowed shadow-md shadow-brand-600/20"
        >
