    ...
    <header className="bg-slate-900/90 backdrop-blur border-b border-slate-800 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <div>
              ...
              <span className="block text-[10px] text-teal-400 font-mono tracking-wider uppercase font-semibold">
          ...
          {projectTitle && (
            <div className="hidden md:flex items-center space-x-2 pl-4 border-l border-slate-800 text-sm">
              <span className="text-slate-400 text-xs uppercase tracking-wider font-mono">Active Initiative:</span>
              <span className="font-semibold text-slate-200 truncate max-w-xs">{projectTitle}</span>
              {moleculeName && (
                <span className="bg-brand-950 text-brand-300 text-xs px-2.5 py-0.5 rounded-full border border-brand-800 font-mono">
                  {moleculeName}
                </span>
              )}
            </div>
        ...
        <div className="flex items-center space-x-3">
          <Link
            href="/"
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-sm text-slate-300 hover:text-white hover:bg-slate-800 transition"
          >
          ...
          <div className="flex items-center space-x-2 bg-slate-800/80 px-3 py-1.5 rounded-lg border border-slate-700/60 text-xs">
            ...
            <span className="text-slate-300 font-medium">10 Core Modules Active</span>
          </div>
        </div>
      </div>
    </header>
