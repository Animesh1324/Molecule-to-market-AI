    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Comparing Conservative, Base-Case Realistic, and Aggressive Guideline Adoption</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-slate-200 dark:border-slate-800">
        <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800">
          <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Conservative Peak (Yr 5)</div>
        ...
        <div className="p-3.5 rounded-xl bg-brand-50 dark:bg-brand-950/40 border border-brand-800/60">
        ...
        <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-800/60">
