  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-bold text-slate-100">Perceptual Competitive Positioning Quadrant</h3>
          <p className="text-xs text-slate-400">Hard Clinical Efficacy (X-Axis) vs. Safety, Tolerability & Convenience (Y-Axis)</p>
        </div>
      ...
      {/* 2x2 Grid Canvas */}
      <div className="relative w-full h-80 bg-slate-950 rounded-xl border border-slate-800 overflow-hidden my-4 p-4">
        {/* Quadrant Axes */}
        ...
        {/* Quadrant Labels */}
        <div className="absolute top-2 right-3 text-[10px] font-bold text-emerald-400/60 uppercase tracking-wider">
          Premier: High Efficacy & High Safety
        </div>
        <div className="absolute top-2 left-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
          Niche: High Safety / Modest Efficacy
        </div>
        <div className="absolute bottom-2 right-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
              ...
              <div
                className={`w-5 h-5 rounded-full flex items-center justify-center shadow-lg transition-all ${
                  p.isTarget
                    ...
                    : 'bg-brand-600 ring-2 ring-brand-400/40 text-white'
                }`}
              >
                <span className="text-[9px] font-bold">{p.isTarget ? '★' : idx}</span>
              </div>
              <div className="mt-1 px-2 py-0.5 rounded bg-slate-900/90 border border-slate-700 text-[10px] font-semibold text-slate-200 whitespace-nowrap shadow-md">
      ...
      <div className="flex flex-wrap items-center justify-between text-xs text-slate-400 pt-2">
        ...
        <span className="font-semibold text-slate-200">X-Axis: Level-1 Hard Endpoint Efficacy</span>
